...
def write_csv(list_to_be_inserted):
    with open('entertainment_unit_page_url.csv', mode='w', newline='') as unit_url_list:
...
with open('entertainment_main_page_url.csv') as main_url_csv:
